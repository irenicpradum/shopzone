            ...
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-body p-4 p-md-5">
                    ...
                    <form action="{{ url('/admin/products/update/' . $product->id) }}" method="POST">
                        ...
                        <!-- Image Preview Box -->
                        <div class="mb-4">
                            <label class="form-label fw-semibold text-muted small d-block">Current / Updated Image</label>
                            <div class="border rounded-3 p-2 bg-light d-inline-block text-center" style="min-width: 140px; min-height: 140px;">
                                <img id="previewImg" 
                                     src="{{ old('gallery', $product->gallery) ? old('gallery', $product->gallery) : 'https://placehold.co/140x140?text=No+Image' }}" 
                                     alt="Preview" 
...
function updateImagePreview(url) {
    ...
    if (url.trim() !== '') {
        ...
        preview.src = 'https://placehold.co/140x140?text=No+Image';
    }
}
</script>
