            ...
            <div class="col-12 col-sm-10 col-md-7 col-lg-5 col-xl-4">
                <div class="liquid-card">
                    <div class="liquid-card-body">
                        ...
                        <!-- Validation Errors -->
                        @if ($errors->any())
                            <div class="liquid-alert liquid-error alert">
                        ...
                        <form action="/register" method="POST">
                            ...
                            <!-- Name -->
                            <div class="mb-3">
                                <label for="name" class="liquid-label">
                                    Full Name
                                </label>
                            ...
                            <!-- Confirm Password -->
                            <div class="mb-4">
                                <label for="password_confirmation" class="liquid-label">
                                    Confirm Password
                                </label>
                                <div class="liquid-input-group">
                                    <span class="liquid-input-icon">
                            ...
                            <!-- Register Button -->
                            <div class="d-grid">
                                <button type="submit" class="liquid-login-btn">
                        ...
                        <div class="text-center mt-4">
                            <p class="liquid-register-text mb-0">
                                ...
                                <a href="{{ url('/login') }}" class="liquid-register-link">
                                    Login
                                </a>
                            </p>
                        </div>
